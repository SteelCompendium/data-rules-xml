<ability>
  <name>Tactician Advancement Table</name>
  <keywords>
    <keyword>Level</keyword>
  </keywords>
  <type>Features</type>
  <distance>1st</distance>
  <target>Tactical Doctrine, Focus, Doctrine Feature, Doctrine Triggered Action, Field Arsenal, Mark, Strike Now, Tactician Abilities</target>
  <metadata>
    <class>tactician</class>
    <feature_type>trait</feature_type>
    <file_dpath>Tactician/1st-Level Features</file_dpath>
    <item_id>tactician-advancement-table</item_id>
    ...
    <scdc>1.1.1:10.1.4.1:07</scdc>
    <source>mcdm.heroes.v1</source>
    <type>feature/trait/tactician/1st-level-feature</type>
  </metadata>
  <effects>
    <effect type="mundane">| 2nd   | Perk, Doctrine Feature, Doctrine Ability                                                                                    | 3, 5           | 5                  |
...
| 10th  | Characteristic Increase, Command, Perk, Skill, True Focus, Warmaster                                                        | 3, 5, 7, 9, 11 | 5, 9, 11           |</effect>
  </effects>
</ability>
